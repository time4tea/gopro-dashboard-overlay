...
- 0.98.0 [Feature] Add configurable background colour with `--bg rgba` thanks to https://github.com/mishuha in discussion https://github.com/time4tea/gopro-dashboard-overlay/discussions/120 for the concept. 
